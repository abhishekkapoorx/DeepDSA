...
export const DISCUSSION_TAGS = {
  ...
  export const getAllTags = () => {
    return Object.values(DISCUSSION_TAGS) as (typeof DISCUSSION_TAGS[keyof typeof DISCUSSION_TAGS])[];
  };
  ...
  export const validateTags = (tags: string[]): tags is (typeof DISCUSSION_TAGS[keyof typeof DISCUSSION_TAGS])[] => {
    const validTags = getAllTags();
    return tags.every(tag => validTags.includes(tag as any));
  };